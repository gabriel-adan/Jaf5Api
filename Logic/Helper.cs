...
namespace Logic
{
    public static class Helper
    {
        ...
        public static TEnum TryParseEnum<TEnum>(this int enumValue, string message)
        {
        ...
        public static void ThrowIfNull(object entity, string message)
        {
            if (entity == null)
                throw new ArgumentException(message);
        }

        public static void ThrowIfExists(object entity, string message)
        {
            if (entity != null)
                throw new ArgumentException(message);
        }
